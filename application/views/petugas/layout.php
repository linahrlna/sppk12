 ...
 <body class="hold-transition skin-purple-light fixed sidebar-mini" <?php echo isset($ngapp) ? $ngapp : null; ?>>
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php site_url('petugas') ?>" class="logo">
        ...
        <?php } else { ?>
          <span class="logo-mini"><img src="<?php echo media_url('img/logo.png') ?>" style="height: 40px; margin-top: 5px; margin-left:5px;" class="pull-left"></span>
        <?php } ?>
        <?php if (!empty(logo())) { ?>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg pull-left"><img src="<?php echo upload_url('school/logo_smk.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>SPP SMKN 12 MALANG</b></span>
        <?php } else { ?>
          <span class="logo-lg pull-left"><img src="<?php echo media_url('img/logo.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;<?php echo $this->config->item('app_name') ?></b></span>
        <?php } ?>
      </a>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo site_url('petugas/profile') ?>" class="btn btn-default btn-flat">Profil</a>
                  </div>
                  <div class="pull-right">
                    <a href="<?php echo site_url('petugas/auth/logout?location=' . htmlspecialchars($_SERVER['REQUEST_URI'])) ?>" class="btn btn-default btn-flat">Keluar</a>
                  </div>
                </li>
              </ul>
            </li>
