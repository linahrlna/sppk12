  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('student') ?>" class="logo">
        ...
        <?php } else { ?>
        <span class="logo-lg"><img src="<?php echo media_url('img/logo.png') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;<?php echo $this->config->item('app_name') ?></b></span>
        <?php } ?>
      </a>
