				...
				<div class="box box-success">
					<div class="box-header with-border">
						...
						<?php if ($f['n'] AND $f['r'] != NULL) { ?>
							<a href="<?php echo site_url('petugas/payout/printBill' . '/?' . http_build_query($f)) ?>" target="_blank" class="btn btn-danger btn-xs pull-right">Cetak Semua Tagihan</a>
						<?php } ?>
					</div><!-- /.box-header -->
					<div class="box-body">
						<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="box box-primary">
							...
							<div class="box-body">
								<form action="<?php echo site_url('petugas/payout/cetakBukti') ?>" method="GET" class="view-pdf">
