				...
				<div class="box"> 
					<div class="box-header">
						...
						<div style="margin-top: -30px; margin-left: 185px;">
							<form action="<?php echo site_url('petugas/student/multiple'); ?>" method="post">
										...
										foreach ($student as $row):
											...
											<tr>
												...
												<td>
													...
													<?php } ?>
													<a href="<?php echo site_url('petugas/student/printPdf/' . $row['student_id']) ?>" class="btn btn-success btn-xs view-pdf" data-toggle="tooltip" title="Cetak Kartu"><i class="fa fa-print"></i></a>
												</td>	
											</tr>
											<?php
											$i++;
