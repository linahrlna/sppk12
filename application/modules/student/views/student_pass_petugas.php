				...
				<div class="box">
					<div class="box-body">
						...
						<table class="table table-hover table-bordered table-responsive">
							<form action="<?php echo site_url('petugas/student/multiple'); ?>" method="post" id="lulus">
					...
					<div class="col-md-5">
						<div class="box">
							<div class="box-body">
								...
								<table class="table table-hover table-bordered table-responsive">
									<form action="<?php echo site_url('petugas/student/multiple'); ?>" method="post" id="kembali">
