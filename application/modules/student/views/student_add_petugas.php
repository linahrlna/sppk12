...
<div class="content-wrapper"> 
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('petugas/students') ?>">Manage students</a></li>
			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('petugas/student'); ?>" class="btn btn-block btn-info">Batal</a>
						<?php if (isset($student)) { ?>
	...
	<div class="modal fade" id="deleteStudent">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="<?php echo site_url('petugas/student/delete') ?>" method="POST">
					<div class="modal-body">
...
<script>
	...
	classApp.controller('classCtrl', function($scope, $http) {
		...
		$scope.submit = function(student) {
			...
			$.ajax({
				method: "POST",
				url: SITEURL + "petugas/student/add_class",
				data: postData,
