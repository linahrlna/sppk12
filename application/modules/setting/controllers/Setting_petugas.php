...
class Setting_petugas extends CI_Controller {
    ...
    public function index() {
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            $status =$this->Setting_model_petugas->save($param);
            ...
            if (!empty($_FILES['setting_logo']['name'])) {
                ...
                $this->Setting_model_petugas->save($paramsupdate);
            } 
            ...
            $data['setting_address'] = $this->Setting_model_petugas->get(array('id' => 2));
            $data['setting_phone'] = $this->Setting_model_petugas->get(array('id' => 3));
            $data['setting_district'] = $this->Setting_model_petugas->get(array('id' => 4));
            $data['setting_city'] = $this->Setting_model_petugas->get(array('id' => 5));
            $data['setting_logo'] = $this->Setting_model_petugas->get(array('id' => 6));
            $data['setting_level'] = $this->Setting_model_petugas->get(array('id' => 7));
            $data['setting_user_sms'] = $this->Setting_model_petugas->get(array('id' => 8));
            $data['setting_pass_sms'] = $this->Setting_model_petugas->get(array('id' => 9));
            $data['setting_sms'] = $this->Setting_model_petugas->get(array('id' => 10));
            
            $data['main'] = 'setting/setting_list_petugas';
