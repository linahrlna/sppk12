...
class Profile_petugas extends CI_Controller {
  ...
  public function __construct()
    {
        ...
        $this->load->model(array('users/Users_model_petugas','logs/Logs_model_petugas'));
    ...
    public function edit($id = NULL) {
        ...
        if ($_POST == TRUE) {
            ...
            if ($this->input->post('user_id')) {
                redirect('petugas/profile/edit/' . $this->input->post('user_id'));
            }
    ...
    function cpw() {
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            $data['main'] = 'profile/change_pass_petugas';
            $this->load->view('petugas/layout', $data);
        }
    }
