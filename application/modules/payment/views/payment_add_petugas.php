...
<div class="content-wrapper"> 
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('petugas/payment') ?>">Manage payment</a></li>
			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('petugas/payment'); ?>" class="btn btn-block btn-info">Batal</a>
		...
		<div class="modal fade" id="deletePayment">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="<?php echo site_url('petugas/payment/delete') ?>" method="POST">
