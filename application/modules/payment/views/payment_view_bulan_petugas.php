						...
						<tbody>
							...
							foreach ($student as $row):
								...
								<tr>
									...
									<?php endif ?>
									<td>
										<a href="<?php echo site_url('petugas/payment/edit_payment_bulan_petugas/'. $row['payment_payment_id'].'/'.$row['student_student_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Ubah Tarif"><i class="fa fa-edit"></i></a>
