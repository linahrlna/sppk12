			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header">
						<a href="<?php echo site_url('petugas/payment/add') ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								if (!empty($payment)) {
									foreach ($payment as $row):
										...
										<tr>
											...
											<td>
												...
												href="<?php echo site_url('petugas/payment/view_bulan/' . $row['payment_id']) ?>">
												Setting Tarif Pembayaran
											</a>
											<?php } else { ?>
											<a data-toggle="tooltip" data-placement="top" title="Ubah"
											class="btn btn-primary btn-xs"
											href="<?php echo site_url('petugas/payment/view_bebas/' . $row['payment_id']) ?>">
											Setting Tarif Pembayaran
										</a>
										<?php }?>
									</td>
									...
									<td>
										<a href="<?php echo site_url('petugas/payment/edit/' . $row['payment_id']) ?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
