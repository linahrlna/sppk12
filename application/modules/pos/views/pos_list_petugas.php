								...
								if (!empty($pos)) {
									...
									foreach ($pos as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('petugas/pos/edit/' . $row['pos_id']) ?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
											</td>	
										</tr>
										<?php
										$i++;
	...
	<div class="modal fade" id="addPos" role="dialog">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<?php echo form_open('petugas/pos/add_glob', array('method'=>'post')); ?>
