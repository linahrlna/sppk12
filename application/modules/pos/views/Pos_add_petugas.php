...
<div class="content-wrapper"> 
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('petugas/pos') ?>">Tahun Ajaran</a></li>
			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('petugas/pos'); ?>" class="btn btn-block btn-info">Batal</a>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="modal-footer">
						<?php echo form_open('petugas/pos/delete/' . $pos['pos_id']); ?>
