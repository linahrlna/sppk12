...
class Pos_petugas extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('pos/Pos_model_petugas', 'payment/Payment_model_petugas', 'logs/Logs_model_petugas'));
    ...
    public function index($offset = NULL) {
        ...
        $data['main'] = 'pos/pos_list_petugas';
    ...
    public function add($id = NULL) {
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            if ($this->input->post('pos_id')) {
                redirect('petugas/pos/edit/' . $this->input->post('pos_id'));
            }
