...
class Report_petugas extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model(array('payment/Payment_model_petugas', 'student/Student_model_petugas', 'period/Period_model_petugas', 'pos/Pos_model_petugas', 'bulan/Bulan_model_petugas', 'bebas/Bebas_model', 'bebas/Bebas_pay_model', 'setting/Setting_model_petugas', 'kredit/Kredit_model_petugas', 'debit/Debit_model_petugas', 'logs/Logs_model_petugas'));
	...
	public function report_bill() {
		...
		$data['main'] = 'report/report_bill_list_petugas';
		$this->load->view('petugas/layout', $data);
	}
