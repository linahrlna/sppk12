								...
								if (!empty($classes)) {
									...
									foreach ($classes as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('petugas/class/edit/' . $row['class_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('petugas/class/delete/' . $row['class_id']); ?>
		...
		<div class="modal fade" id="addClass" role="dialog">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<?php echo form_open('petugas/class/add_glob', array('method'=>'post')); ?>
					<div class="modal-body">
