								...
								if (!empty($debit)) {
									...
									foreach ($debit as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('petugas/debit/edit/' . $row['debit_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('petugas/debit/delete/' . $row['debit_id']); ?>
		...
		<div class="modal fade" id="addDebit" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<?php echo form_open('petugas/debit/add_glob', array('method'=>'post')); ?>
					<div class="modal-body">
