...
<div class="content-wrapper">
								...
								if (!empty($kredit)) {
									...
									foreach ($kredit as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('petugas/kredit/edit/' . $row['kredit_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('petugas/kredit/delete/' . $row['kredit_id']); ?>
		...
		<div class="modal fade" id="addKredit" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<?php echo form_open('petugas/kredit/add_glob', array('method'=>'post')); ?>
					<div class="modal-body">
	...
	<?php $this->load->view('petugas/rupiah'); ?>