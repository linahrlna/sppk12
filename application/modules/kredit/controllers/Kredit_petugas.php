...
class Kredit_petugas extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model(array('kredit/Kredit_model_petugas', 'logs/Logs_model_petugas'));
	...
	public function index($offset = NULL) {
		...
		$data['main'] = 'kredit/kredit_list_petugas';
	...
	public function add($id = NULL) {
		...
		if ($_POST AND $this->form_validation->run() == TRUE) {
			...
			if ($this->input->post('kredit_id')) {
				redirect('petugas/kredit/edit/' . $this->input->post('kredit_id'));
			}
	...
	public function delete($id = NULL) {
		if ($_POST) {
			...
			redirect('petugas/kredit/edit/' . $id);
		}
	}
