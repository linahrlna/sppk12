			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
					<div class="box-body box-profile">
						...
						<a href="<?php echo site_url('petugas/users/rpw/'. $user['user_id']) ?>" class="btn btn-info btn-block"><b>Reset Password</b></a>

						<?php } else { ?>
													
						<a href="<?php echo site_url('petugas/profile/cpw/') ?>" class="btn btn-info btn-block"><b>Ubah Password</b></a>
						<?php } ?>
			...
			<div class="col-md-8">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('petugas/users/edit/' . $user['user_id']) ?>" class="btn btn-success"><b>Edit</b></a>
					</div>
					<!-- /.box-body -->
				</div>
				<!-- /.box -->
