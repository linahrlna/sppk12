								...
								if (!empty($majors)) {
									...
									foreach ($majors as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('petugas/majors/edit/' . $row['majors_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('petugas/majors/delete/' . $row['majors_id']); ?>
		...
		<div class="modal fade" id="addMajors" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<?php echo form_open('petugas/majors/add_glob', array('method'=>'post')); ?>
					<div class="modal-body">
